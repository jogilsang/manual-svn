...
my $opt_token = "WewhYYKZnaEpOZzbSXMgw9nM"; # The token from your SVN services page
...
# 한글 사용을 위해 변경
# my $log = qx|export LC_ALL="ko_KR.UTF-8"; svnlook log -r $ARGV[1] $ARGV[0]|;
# $log = decode_utf8($log);
